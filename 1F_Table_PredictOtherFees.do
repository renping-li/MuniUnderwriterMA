...
local outfile =  "../Slides/tabs/PredictOtherFees.tex"
local outputoptions = "nor2 dec(3) stats(coef tstat) tdec(2) nonotes adec(3)"

/* Column 1 */

import delimited "../RawData/California/CDA_All_Data_RegData_CRRatio.csv", clear
...
reg crratio inc_to_avg pop_to_avg ///
...
import delimited "../RawData/California/CDA_All_Data_RegData_InsureRatio.csv", clear
...
reg insureratio inc_to_avg pop_to_avg ///
maturity_bracket_1 maturity_bracket_2 maturity_bracket_3 maturity_bracket_4 maturity_bracket_5 maturity_bracket_6 ///
amount_bracket_1 amount_bracket_2 amount_bracket_3 amount_bracket_4 amount_bracket_5 ///
bidN taxT taxA security_type_RV
...
import delimited "../RawData/California/CDA_All_Data_RegData_AdvisorRatio.csv", clear
...
reg advisorratio inc_to_avg pop_to_avg ///
maturity_bracket_1 maturity_bracket_2 maturity_bracket_3 maturity_bracket_4 maturity_bracket_5 maturity_bracket_6 ///
amount_bracket_1 amount_bracket_2 amount_bracket_3 amount_bracket_4 amount_bracket_5 ///
bidN taxT taxA security_type_RV
