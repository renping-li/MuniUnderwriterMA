...
local outfile =  "../Slides/tabs/DID_MAQuant.tex"
...
if "$MainThreshold" == "HHI" {
	...
	import delimited "../CleanData/MAEvent/CSA_episodes_marketshareByN_Quant.csv", clear
}
...
addstat("Within R-squared", e(r2_within)) addtext("Year FE", "Yes","County FE", "Yes","Clustering","County")
...
// 	keep(treatedXpost treatedXpostXhhi_dif_200_300 treatedXpostXhhi_dif_gt300) `outputoptions' ctitle("log(Amount)","\;") ///
// 	addstat("Within R-squared", e(r2_within)) addtext("Year FE", "Yes","County FE", "Yes","Clustering","County")
}
...
if "$MainThreshold" == "MarketShare" {
	...
	reghdfe log_amount treated post if_max_sum_share_10_25 if_max_sum_share_gt_25 ///
	treatedXpost TXPXmax_sum_share_10_25 TXPXmax_sum_share_gt_25, /// 
	absorb(i.county_code calendar_year) cluster(i.county_code)
// 	outreg2 using  "`outfile'", tex(fragment) append label ///
// 	keep(treatedXpost TXPXmax_sum_share_10_25 TXPXmax_sum_share_gt_25) `outputoptions' ctitle("log(Amount)","\;") ///
// 	addstat("Within R-squared", e(r2_within)) addtext("Year FE", "Yes","County FE", "Yes","Clustering","County")
}
...
absorb(i.county_code calendar_year) cluster(i.county_code)
// outreg2 using  "`outfile'", tex(fragment) append label ///
// keep(treatedXpost treatedXpostXavghhi_1000_2000 treatedXpostXavghhi_2000_3000 treatedXpostXavghhi_gt3000) `outputoptions' ctitle("log(Amount)","\;") ///
// addstat("Within R-squared", e(r2_within)) addtext("Year FE", "Yes","County FE", "Yes","Clustering","County")
...
keep(treatedXpost) `outputoptions' ctitle("log Amount","per Capita") addstat("Within R-squared", e(r2_within)) ///
...
if "$MainThreshold" == "MarketShare" {
	...
	// Column 5: By market share of merging entities
	reghdfe log_amount_per_pop treated post if_max_sum_share_10_25 if_max_sum_share_gt_25 ///
	treatedXpost TXPXmax_sum_share_10_25 TXPXmax_sum_share_gt_25, /// 
	absorb(i.county_code calendar_year) cluster(i.county_code)
	outreg2 using  "`outfile'", tex(fragment) append label ///
	keep(treatedXpost TXPXmax_sum_share_10_25 TXPXmax_sum_share_gt_25) `outputoptions' ctitle("log Amount","per Capita") ///
	addstat("Within R-squared", e(r2_within)) addtext("Year FE", "Yes","County FE", "Yes","Clustering","County")
}
...
absorb(i.county_code calendar_year) cluster(i.county_code)
outreg2 using  "`outfile'", tex(fragment) append label ///
keep(treatedXpost treatedXpostXavghhi_1000_2000 treatedXpostXavghhi_2000_3000 treatedXpostXavghhi_gt3000) `outputoptions' ctitle("log Amount","per Capita") addstat("Within R-squared", e(r2_within)) addtext("Year FE", "Yes","County FE", "Yes","Clustering","County")
