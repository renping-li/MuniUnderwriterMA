...
addstat("Adjusted R-squared", e(r2_a)) addtext("Year FE", "No","Cohort \(\times\) Year FE", "Yes","Issuer FE","No","Issuer \(\times\) Cohort FE", "Yes","Clustering","CSA \& Year")
...
reghdfe gross_spread_inbp hhi_by_n, ///
absorb(i.issuer_code##i.issuer_type calendar_year) cluster(csacode calendar_year) noconstant

outreg2 using  "`outfile'", tex(fragment) append label keep(hhi_by_n) `outputoptions' ctitle("Underwriting","Spread (bps.)") ///
addstat("Adjusted R-squared", e(r2_a)) addtext("Year FE", "Yes","Cohort \(\times\) Year FE","No","Issuer FE","Yes","Issuer \(\times\) Cohort FE", "No","Clustering","CSA \& Year")
...
ivreghdfe gross_spread_inbp (hhi_by_n=treatedXpost) ///
if year_to_merger>=-4&year_to_merger<=4, ///
absorb(i.issuer_code##i.issuer_type##i.episode_start_year##i.treated_csa i.episode_start_year##i.treated_csa##i.calendar_year) ///
cluster(csacode calendar_year) noconstant
...
addtext("Year FE", "No","Cohort \(\times\) Year FE","Yes","Issuer FE","No","Issuer \(\times\) Cohort FE", "Yes","Clustering","CSA \& Year")
...
outreg2 using  "`outfile'", tex(fragment) append label ///
keep(hhi_by_n) `outputoptions' ctitle("Underwriting","Spread (bps.)") ///
addtext("Cohort \(\times\) Year FE", "Yes","Issuer \(\times\) Cohort FE", "Yes","Clustering","CSA \& Year")
